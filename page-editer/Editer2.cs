            ...
            using (MySqlDataReader Liretab = lirecmd.ExecuteReader())//lecture dans bd
            {
                while (Liretab.Read())//tant qu'on lit dans la bd
                {
                        ...
                        attend que la boucle arrive au bon ID dans la lecture*/
                    {
                        ...
                        {
                            if (h2g != 0)//cette condition est faite pour afficher corectement lors de l'ouverture
                            {
            ...
            try
            {
                ...
                using (MySqlDataReader Liretab = viewcmd.ExecuteReader())//lectcure dans table
                {
                    while (Liretab.Read())//tant qu'on lit dans la bd
                    {
                        ...
                        if (Th1 != totale)
                        {
                            if (cb2 - cb1 == 10 || cb1 - cb2 == 30)//si on veut parcourir 1 tajet
                            {
                           ...
                           if (cb2 - cb1 == 20 || cb1 - cb2 == 20)//si on veut parcourir 2 tajet
                            {
                            ...
                            if (cb2 - cb1 == 30 || cb1 - cb2 == 10)//si on veut parcourir 3 tajet
                            {
                            ...
                            if (cb2 - cb1 == 30 || cb1 - cb2 == 10)//si on veut parcourir 3 tajet
                            {
                                if (Th1 + 270 < h3)
                                {
                                    MessageBox.Show("l'heure est trop tôt");
                                }
                            }*/
                        }
                ...
                if(cb1 != cb2)
                {
                    if (Th1 != totale)
                    {
                        if (cb2 - cb1 == 10 || cb1 - cb2 == 30)//si on veut parcourir 1 tajet
                        {
                            if (Th1 >= totale - 90 && Th1 <= totale + 90)
                            {
                                MessageBox.Show("un trajet sera deja commencer");
                            }
                        }
                        ...
                        else
                        {
                            ...
                            MySqlCommand insertcmd = new MySqlCommand("UPDATE trajets  SET heuredep=@heuredep, charg=@charg, dechar=@dechar, depart=@depart, destination=@destination WHERE ID=@ID", cnx);
                            //transfere valeur de bd au programme
